...
/**
 * Settings form for the Authorship Check activity.
 *
...
class mod_authorcheck_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement(
            'text',
            'name',
            get_string('authorcheckname', 'mod_authorcheck'),
            ['size' => '64']
        );
        ...
        $mform->addElement(
            'select',
            'assignmentid',
            get_string('linkedassignment', 'mod_authorcheck'),
            $assignoptions
        );
        ...
        $mform->addElement(
            'date_time_selector',
            'releasetime',
            get_string('releasetime', 'mod_authorcheck'),
            ['optional' => true]
        );
        ...
        $mform->addElement(
            'text',
            'timelimit',
            get_string('timelimit', 'mod_authorcheck'),
            ['size' => 5]
        );
